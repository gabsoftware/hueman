...
if ( ! function_exists( 'alx_sidebars' ) ) {
	...
	function alx_sidebars()	{
		...
		if ( ot_get_option('before-nav-widget') == 'on' ) { register_sidebar(array( 'name' => 'Before Navigation Widget','id' => 'before-nav-widget', 'description' => "Widget placed before the navigation links", 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>')); }
		if ( ot_get_option('before-rel-widget') == 'on' ) { register_sidebar(array( 'name' => 'Before Related Widget'   ,'id' => 'before-rel-widget', 'description' => "Widget placed before the related posts"   , 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>')); }
